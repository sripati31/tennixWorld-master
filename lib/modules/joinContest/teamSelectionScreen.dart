      ...
      children: <Widget>[
        Container(
          ...
          child: Text(
            ...
            textAlign: TextAlign.center,
            style: TextStyle(fontFamily: 'Poppins', fontSize: AppConstant.SIZE_TITLE16),
          ),
        ),
        Divider(
          height: 1,
          ...
          Container(
            child: Column(
              children: <Widget>[
                ...
                Text(
                  '$teamA',
                  style: TextStyle(fontFamily: 'Poppins', fontSize: AppConstant.SIZE_TITLE18, fontWeight: FontWeight.bold),
                ),
              ],
            ),
          ),
          ...
          Container(
            child: Row(
              ...
              children: <Widget>[
                Text(
                  'Wk  ',
                  style: TextStyle(fontFamily: 'Poppins', color: AllCoustomTheme.getTextThemeColors(), fontSize: AppConstant.SIZE_TITLE14),
                ),
                Text('1'),
              ],
            ),
