              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      "Vs",
                      style: TextStyle(fontFamily: 'Poppins', fontSize: AppConstant.SIZE_TITLE12, fontWeight: FontWeight.bold),
                    ),
                    Container(
                      width: 50,
                      height: 50,
            ...
            child: ListView(
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      rank("Rank #1", "Virat k 13", "won ₹9,000", AppConstant.virat),
                      SizedBox(
                        width: 4,
                      ),
                      rank("Rank #2", "Dhoni k 13", "won ₹7,000", AppConstant.dhoni),
                      SizedBox(
                        width: 4,
                      ),
                      rank("Rank #3", "Rehna k 13", "won ₹5,000", AppConstant.playerImage),
                      SizedBox(
                        width: 4,
                      ),
                    ],
