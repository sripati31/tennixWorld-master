...
import 'package:TennixWorldXI/models/bankListResponseData.dart';
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: new Border.all(
                              width: 2.0,
                              color: data.isSelected! ? AllCoustomTheme.getThemeData().primaryColor : AllCoustomTheme.getTextThemeColors().withOpacity(0.5),
                            ),
                          ),
                          child: Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Container(
                                child: Text(
                                  '${data.branchName}',
                                  style: TextStyle(fontFamily: 'Poppins', color: Colors.grey, fontSize: AppConstant.SIZE_TITLE14),
                                ),
                              ),
                              Container(
