...
import 'package:TennixWorldXI/models/leagueMemberListResponse.dart' as leagues;
import 'package:TennixWorldXI/models/leagueMemberTeamResponse.dart' as leagueMember;
import 'package:TennixWorldXI/models/scheduleResponseData.dart';
import 'package:TennixWorldXI/models/scorecardResponce.dart';
import 'package:TennixWorldXI/models/shedualResults.dart';
import 'package:TennixWorldXI/models/userData.dart';
import 'package:TennixWorldXI/modules/contests/contestsPoolView.dart';
import 'package:TennixWorldXI/modules/contests/leagueTeamPreview.dart';
import 'package:TennixWorldXI/modules/contests/playersPointInfoScreen.dart';
import 'package:TennixWorldXI/modules/createTeam/createTeamScreen.dart';
import 'package:TennixWorldXI/modules/home/standingScreen.dart';
import 'package:TennixWorldXI/modules/joinContest/teamSelectionScreen.dart';
import 'package:TennixWorldXI/modules/myProfile/publicProfile.dart';
...
class _LeagueInfoScreenState extends State<LeagueInfoScreen> with SingleTickerProviderStateMixin {
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                      ...
                      style: TextStyle(fontFamily: 'Poppins', fontSize: 28, color: AllCoustomTheme.getBlackAndWhiteThemeColors(), fontWeight: FontWeight.bold),
                    ),
                  ),
                ],
              ),
  ...
  Widget dowunloadbar() {
    return Container(
      ...
      color: contestJoinedData != null && contestJoinedData.isFull == '0' ? Colors.red.withOpacity(0.1) : AllCoustomTheme.getTextThemeColors().withOpacity(0.1),
      child: Row(
        children: <Widget>[
          Expanded(
            child: Container(
              ...
              child: widget.tabtype == TabType.Upcoming
                  ? Text(
                      'view all teams \nafter the deadline',
                      style: TextStyle(fontFamily: 'Poppins', fontSize: AppConstant.SIZE_TITLE12, color: AllCoustomTheme.getTextThemeColors()),
                    )
                            ...
                            child: Row(
                              children: <Widget>[
                                Text(
                                  ...
                                  style: TextStyle(fontFamily: 'Poppins', fontSize: AppConstant.SIZE_TITLE14, color: Colors.red),
                                ),
                              ],
                            ),
                          ),
...
class LeaguesListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      color: leagueTeam!.userId == Utils.userData!.userId ? AllCoustomTheme.getThemeData().primaryColor.withOpacity(0.1) : Colors.transparent,
      child: InkWell(
        onTap: () {
          allClick!();
        },
                ...
                children: <Widget>[
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: leagueTeam!.image != ""
                          ? AvatarImage(
                              imageUrl: AppConstant.UserImageUrl + leagueTeam!.image!,
                              sizeValue: 44,
                              radius: 44,
                              isCircle: true,
                            )
                          : Image.asset(AppConstant.userAvatar),
                    ),
                  ),
                  Expanded(
                    child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      tabtype == TabType.Live
                                          ? Text(
                                              '  IN WINNING...',
                                              style: TextStyle(fontFamily: 'Poppins', fontSize: AppConstant.SIZE_TITLE10, fontWeight: FontWeight.bold, color: Colors.green),
                                            )
                                          : Text(
                  ...
                  tabtype == TabType.Upcoming
                      ? Container(
                          width: 50,
                          height: 50,
                          child: leagueTeam!.userId == Utils.userData!.userId
                              ? InkWell(
                                  onTap: () {
                                    swapeTeamClick!();
                                  },
                              ...
                              tabtype == TabType.Live
                                  ? leagueTeam!.pointsStatus == "="
                                      ? Container(
                                          width: 22,
                                          height: 22,
                                          child: Image.asset(AppConstant.arrowE),
                                        )
                                      : leagueTeam!.pointsStatus == ">"
                                          ? Container(
                                              width: 22,
                                              height: 22,
                                              child: Image.asset(AppConstant.arrowG),
                                            )
                                          : leagueTeam!.pointsStatus == "<"
                                              ? Container(
                                                  width: 22,
                                                  height: 22,
                                                  child: Image.asset(AppConstant.arrowL),
                                                )
                                              : SizedBox()
                                  : SizedBox()
                            ],
