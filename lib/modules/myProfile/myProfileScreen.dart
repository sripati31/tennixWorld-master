...
import 'package:TennixWorldXI/modules/myProfile/transectionHistoryScreen.dart';
import 'package:TennixWorldXI/modules/myProfile/updateProfileScreen.dart';
...
import '../../models/DrawerInfoResponceData.dart';
...
class _MyProfileScreenState extends State<MyProfileScreen> with SingleTickerProviderStateMixin {
                ...
                title: Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        Utils.userData?.email??"jaskdghkajsgd",
                        style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 24,
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      "${Utils.userData?.dialCode} ${Utils.userData?.mobileNumber}",
                                      style: TextStyle(
                                        fontFamily: 'Poppins',
                                        fontSize: AppConstant.SIZE_TITLE16,
                                      ),
  ...
  Widget logoutButton() {
    return Container(
      ...
      child: InkWell(
        onTap: () async{
          bool isConfirmed = await Dialogs.showDialogWithTwoButtons(
              context,
  ...
  _logoutUser()async{
    API_STRUCTURE apiObject = API_STRUCTURE(
        context: context,
        apiName: ApiConstant.logoutUser,
    ...
    debugPrint("logout apiResponse:-> $apiResponse");
    if(apiResponse.containsKey(API_RESPONSE.SUCCESS)){
      // LogOut().logout(context);
      Navigator.popUntil(context, (route) => route.isFirst);
      Navigator.pushReplacement(
        AppConstant.mainScreenContext!,
        MaterialPageRoute(
...
class _PlayingHistoryState extends State<PlayingHistory> {
  ...
  void getUserData() async {
    ...
    UserDetail responseData = ApiProvider().getProfile();
