...
import 'package:TennixWorldXI/models/transactionResponse.dart';
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          ...
                                                          style: TextStyle(
                                                            ...
                                                            color: nowDate.difference(fromDate).inDays >= 0 && fromDate.difference(toDate).inDays <= 0 && toDate != fromDate
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          ...
                                                          style: TextStyle(
                                                            fontFamily: 'Poppins',
                                                            fontSize: AppConstant.SIZE_TITLE16,
                                                            color: nowDate.difference(toDate).inDays >= 0 && toDate.difference(fromDate).inDays >= 0 && toDate != fromDate
                                                                ? AllCoustomTheme.getBlackAndWhiteThemeColors()
                                                                : Colors.red,
                                                          ),
                                                        ),
                  ...
                  new Container(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(fontFamily: 'Poppins', fontSize: AppConstant.SIZE_TITLE16, fontWeight: FontWeight.bold, color: AllCoustomTheme.getBlackAndWhiteThemeColors()),
                      ),
                    ),
                  ),
                ],
